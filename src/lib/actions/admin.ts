...
export async function upsertPropertyAction(input: unknown): Promise<ActionState> {
  ...
  const property = {
    ...
    apartment_video_url: parsed.data.apartment_video_url || null,
    condominium_video_url: parsed.data.condominium_video_url || null,
    youtube_embed_url: parsed.data.youtube_embed_url || null,
    map_embed_url: parsed.data.map_embed_url || null,
    gallery_images: parseLines(parsed.data.gallery_images),
    condominium_gallery_images: parseLines(parsed.data.condominium_gallery_images),
    condominium_amenities: parseLines(parsed.data.condominium_amenities),
    condominium_description: parsed.data.condominium_description || null,
